...
- [ ] Manual UI verification partially done; cancel flow now shows 403 PENDING_LOCKED error for pending bookings (toast). Need retest to confirm no JS errors after defensive guard.
