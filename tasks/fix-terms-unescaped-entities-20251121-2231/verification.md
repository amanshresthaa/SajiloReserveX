...
- Notes: `pnpm exec eslint --max-warnings=0 'src/app/(marketing)/terms/page.tsx'` (pass).
...
- [ ] Manual UI QA via Chrome DevTools pending (dev server not run during this step).
